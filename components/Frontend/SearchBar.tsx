...
<form className="max-w-md mx-auto mr-24">   
    ...
    <div className="relative">
        ...
        <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border-2 border-gray-300 rounded-full bg-gray-50  focus:outline-none  focus:ring focus:ring-blue-500" placeholder="Search Doctors, Lab doc..." required />
