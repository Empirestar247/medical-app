...
<form className=" w-[260px] min-[1024px]:max-w-md min-[1024px]:mx-auto min-[1024px]:mr-48">   
    ...
    <div className="relative">
        ...
        <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border-2 border-gray-300 rounded-full bg-gray-50  " placeholder="Search Doctors, Lab doc..." required />
